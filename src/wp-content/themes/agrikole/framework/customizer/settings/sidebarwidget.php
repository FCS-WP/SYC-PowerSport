...
$this->sections['agrikole_sidebar_widget_general'] = array(
	'title' => esc_html__( 'Widget General', 'agrikole' ),
	'panel' => 'agrikole_sidebarwidget',
	'settings' => array(
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Widget Bottom Margin', 'agrikole' ),
		...
		array(
			...
			'control' => array(
				...
				'description' => esc_html__( 'Top Right Bottom Left. Ex: 0px 0px 5px 0px', 'agrikole' ),
			),
			'inline_css' => array(
				'target' => array(
...
// Widget Search
$this->sections['agrikole_sidebar_widget_search'] = array(
...
// Widget Built-In
$this->sections['agrikole_sidebar_widget_built_in'] = array(
	...
	'settings' => array(
		array(
			...
			'control' => array (
				...
				'description' => esc_html__( 'Top Right Bottom Left. Ex: 13px 0px', 'agrikole' ),
			),
			'inline_css' => array(
				'target' => array(
...
// Widget Tags
$this->sections['agrikole_sidebar_widget_tags'] = array(
	'title' => esc_html__( 'Widget: Tags', 'agrikole' ),
	'panel' => 'agrikole_sidebarwidget',
	'settings' => array(
		array(
